...
import { View, Text, StyleSheet, TouchableOpacity, Alert, ActivityIndicator, Platform, Image, Animated, Easing, ScrollView } from 'react-native';
...
const styles = StyleSheet.create({
  ...
  centralArea: { alignItems: 'center', marginVertical: spacing.md, paddingVertical: spacing.xl },
